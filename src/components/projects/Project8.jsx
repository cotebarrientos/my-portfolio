            ...
            <Row className="mt-4 mb-4 info-background" data-aos="fade-left">
                ...
                <Col lg={6} xs={12} className="my-auto">
                    ...
                    <p className="font-exo project-description mt-4">
                        This was the second assignment for the Brainnest specialization course. The main 
                        objective of this project was to test the knowledge acquired about CSS and create 
                        a website as close as possible to the template presented by the tutor of this 
                        course. The template simulates the requirements of a hypothetical client.
                    </p>
                    <p className="font-exo project-description mt-4">
